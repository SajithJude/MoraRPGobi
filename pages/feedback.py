...
class TutorAgent:
    ...
    def generate_question_answer(self, keyword: str) -> (str, str):
        self.reset()
        message = self._llm.chat([ChatMessage(role="system", content=f"Generate a question about the topic: {keyword} and also provide the expected answer separated by a new line.")])
